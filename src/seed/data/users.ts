...
export const USERS_SEED: Prisma.user_ceCreateInput[] = [
  // === ADMIN === //
  {
    name: 'Admin',
  ...
  // === EMPRESAS ( VENDEDOR, COMPRAR ) === //
  {
    ...
    userType: UserType.EMPRESA,
    businessDescription: `
      Corporación Favorita y sus filiales comerciales, industriales e inmobiliarias tienen presencia en todo el país. Sus diferentes líneas de negocio y formatos adaptan el modelo de oferta de productos, servicios y experiencias, a las realidades locales, según sus necesidades. En el ámbito internacional, las filiales de la Corporación tienen actividades en cinco países de la región, además de en Ecuad
    `,
  ...
  },
  {
    ...
    userType: UserType.EMPRESA,
    businessDescription: `
      Las exportaciones efectuadas por Reybanpac han sido de constante crecimiento, desde un millón de cajas exportadas inicialmente, a 27 millones en los últimos años. El banano exportado es de primera calidad de la variedad Cavendish, en cajas de cartón que contienen 18.14kg, 14kg o 13kg netos de fruta, conforme a las preferencias de los diferentes mercados de consumo.
    `,
