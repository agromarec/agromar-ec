...
export declare class PredefinedProductController {
    private readonly predefinedProductService;
    constructor(predefinedProductService: PredefinedProductService);
    ...
    update(id: string, updatePredefinedProductDto: UpdatePredefinedProductDto): Promise<{
        status: import("@prisma/client").$Enums.Status | null;
        modification_date: Date | null;
        creation_user: string | null;
        modification_user: string | null;
